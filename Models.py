...
# ------- This code is taken from https://github.com/benathi/fastswa-semi-sup.
...
def mt_shake_shake_params():
    """
    :return: dicitionary of hyper parameters used for the Fast-SWA and Mean-Teacher model based on the original
    hyper-parameters in https://github.com/benathi/fastswa-semi-sup.
    """
    return {
        "optimizer_args": {
            "lr": 0.05,
